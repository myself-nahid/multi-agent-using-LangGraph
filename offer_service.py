...
# --- UPDATED with better image distribution ---
...
async def update_loop():
    load_cache()
    queries = [
        ("HotelReservation", "luxury hotel exterior", "Paris"),
        ("HotelReservation", "Burj Al Arab hotel", "Dubai"),
        ("RestaurantBooking", "michelin star restaurant food presentation", "Tokyo"),
        ("SpaBooking", "luxury spa resort interior", "Bali"),
        ("ConcertTicketsBooking", "live concert stage lights", "London"),
        ("BirthdayBooking", "rooftop birthday party venue", "Sydney"),
        ("FlightBooking", "Singapore Airlines A380 airplane", "Singapore")
    ]
